...
package com.example.spiderwebtechtask.activity
...
import com.example.spiderwebtechtask.adapter.WeatherForecastAdapter
import com.example.spiderwebtechtask.api.WeatherApiServices
import com.example.spiderwebtechtask.databinding.ActivityWeatherBinding
...
class WeatherActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvLatitude = binding.tvLongitude
    ...
    private fun filterWeatherOnDate(date: String, dateLabel: TextView) {
        ...
        recyclerView = binding.forecastRecyclerList
        recyclerView.layoutManager = GridLayoutManager(this@WeatherActivity,2)
    ...
    private fun setDataOnViews(body: WeatherModel?) {
        ...
        binding.weatherDayTextInWeatherFragment.text = "Date/Time: ${currentDate}"
        binding.tvLatitude.text =  "Coordinates: ${body?.coord?.lat.toString()}"
    ...
    companion object{
        ...
        const val API_KEY ="c0e11deea9fd714874cbf5107f897a28"
    }
